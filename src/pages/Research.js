        ...
        <div className='mt-4'>
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-grow flex-shrink-0">
              <label htmlFor="line" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Ligne</label>
                <button 
                  className="h-full bg-blue-800 hover:bg-blue-700 text-white text-sm font-bold py-2 px-4 rounded flex justify-center items-center"
                  onClick={() => navigate(`/line/${selectedLineID.split(':').pop()}`)}
                >
                  {getLineName(selectedLineID.split(':').pop())}
                  <svg class="ml-3 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 15">
