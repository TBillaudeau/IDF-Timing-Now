      ...
      <AccordionItem
        ...
        content={
          <div className="p-5 border border-b-0 border-gray-200">
            ...
            <p className="text-gray-500">
              Check out the <a href="https://flowbite.com/figma/" className="text-blue-600 hover:underline">Figma design system</a> based on the utility classes from Tailwind CSS and components from Flowbite.
            </p>
          </div>
        }
      />
