  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4 m-2 sm:m-6">
        <div className="bg-white border rounded-lg dark:text-white dark:bg-gray-800 p-4 lg:p-6">
            <h1 className="text-2xl font-bold mb-4 lg:pb-6">Plan du réseau en Île-de-France</h1>
            {maps.map((map, index) => (
                <div key={index} className="mb-4">
                    <h2 className="text-lg font-medium lg:pb-6">{map.name}</h2>
                    <h2 className="xl:text-xl font-bold border-1 mr-4">
            ...
            <h1 className="text-2xl font-bold mb-4 lg:pb-6">Plans des lignes en Île-de-France</h1>
