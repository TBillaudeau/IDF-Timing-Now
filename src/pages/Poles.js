    ...
    return (
        <DragDropContext onDragEnd={handleOnDragEnd}>
            <Droppable droppableId="URLs">
                {(provided) => (
                    <div className="grid grid-cols-1 gap-2 lg:gap-4 m-2" {...provided.droppableProps} ref={provided.innerRef}>
                        <div className="bg-white dark:bg-gray-800 p-4 lg:p-6">
                            ...
                            {URLs.map((pole, index) => (
                                <Draggable key={pole.label} draggableId={pole.label} index={index}>
                                    {(provided) => (
                                        <div className="bg-white dark:bg-gray-800 py-2 lg:py-4" ref={provided.innerRef} {...provided.draggableProps} {...provided.dragHandleProps}>
