...
export default function BottomNavbar() {
    ...
    return (
        <footer className="fixed bottom-0 z-50 w-full -translate-x-1/2 shadow-[0px_-3px_6px_-1px_rgba(0,0,0,0.2)] bg-white border-b-[25px] border-white left-1/2 dark:bg-gray-900 dark:border-gray-900 md:hidden">
            <div class="w-full absolute bottom-[-30px]">
                <div class="grid grid-cols-3 gap-1 mx-auto my-2" role="group">
                    <button class="px-1 py-1 text-xs font-medium text-slate-900 dark:text-white">
                        beta
                    </button>
            ...
            <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
                ...
                <Link to="/recherche" onClick={() => setNavbarOpen(false)} data-tooltip-target="tooltip-home" className={`inline-flex flex-col items-center justify-center m-1 group rounded-lg hover:bg-violet-100 ${location.pathname === "/recherche" ? "bg-violet-100 dark:bg-violet-100 dark:hover:bg-violet-200 text-violet-800" : "text-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 "}`}>
                ...
                <Link to="/a-proximite" onClick={() => setNavbarOpen(false)} data-tooltip-target="tooltip-home" className={`inline-flex flex-col items-center justify-center m-1 group rounded-lg hover:bg-violet-100 ${location.pathname === "/a-proximite" ? "bg-violet-100 dark:bg-violet-100 dark:hover:bg-violet-200 text-violet-800" : "text-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 "}`}>
