      ...
      return (
        <div className="overflow-y-auto max-h-[27rem]">
            <div className="flex items-center bg-white rounded-lg shadow-md h-[44px] lg:h-[72px] p-1 lg:p-4 mb-1 lg:mb-3">
              <div role="status" class="flex items-center justify-center w-4 xl:w-10 h-4 xl:h-10 ml-1 lg:ml-0 mr-2 lg:mr-4 p-1 bg-gray-300 rounded-sm xl:rounded-lg animate-pulse dark:bg-gray-700">
