      ...
      {Object.keys(groupedTrains).map((sens) => (
        <div key={sens}>
          ...
          {groupedTrains[sens].map((train, index) => (
            ...
            <div key={train.time + index} className="flex items-center bg-white border dark:text-white dark:bg-gray-700 rounded-lg shadow-md min-h-[44px] max-h-[72px] p-1 lg:p-4 mb-1 lg:mb-3">
