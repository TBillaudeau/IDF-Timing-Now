            ...
            if (true) {
                ...
                setSvgSrc(`
                    <svg viewBox="0 0 ${estimatedWidth} 120">
                        ...
                        <text x="50%" y="53%" fill="${text_color}" font-family="'Source Code Pro', monospace" font-size="45" text-anchor="middle" alignment-baseline="middle" font-weight="bold">${name}</text>
                    </svg>
                `);
            }
        }
