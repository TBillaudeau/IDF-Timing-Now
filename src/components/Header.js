...
function StationInfo({ transportLogo, lineLogo, stationName }) {
    ...
    return (
        ...
        <div className="flex items-center bg-white border-slate-700 border-solid border-2 p-2 lg:p-4 mb-4 rounded-lg shadow-md min-h-[52px]" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            {disrupted && (
